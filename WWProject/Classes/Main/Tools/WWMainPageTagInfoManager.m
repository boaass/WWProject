...
@implementation WWMainPageTagInfoManager
...
{
    [self loadDataWithUrl:self.method params:self.params block:^(WWMainPageTagInfoManager *manager) {
        block(manager);
    }];
}
